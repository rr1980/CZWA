...
namespace CZWA.Services
{
    public class AccountService
    {
        ...
        private async Task<UserViewModel> _getUserByNameAndPw(string username, string password)
        {
        ...
        private bool _hasRole(UserViewModel user, UserRoleType urt)
        {
            if (user != null)
            {
